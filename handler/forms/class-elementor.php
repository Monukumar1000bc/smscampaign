			...
			foreach($fields as $field){
				if( $field['field_type'] == 'sa_billing_phone' ){
					if( '' === $settings['otp_verification_enable'] && 'on' === $country_flag_enable ){
						echo '<script>
						jQuery(document).ready(function(){
							initialiseCountrySelector("#form-field-'.$field['custom_id'].'");
						})
						</script>';
						...
						echo do_shortcode( '[sa_verify id="" phone_selector="#form-field-'.$field['custom_id'].'" submit_selector=".elementor-field-type-submit .sa-elementor-'.$unique.'"]' );
					?>
					<script>
						jQuery(document).ready(function(){
